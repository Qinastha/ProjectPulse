...
import {deleteData, postData, PROFILE_REQUIRED_INPUTS, ProfileFormData, putData} from "../../core";
...
export const ProfileSettings: React.FC = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await putData("profile/update", formData)
            ...
            if (response.data.value) {
                ...
                alert("Profile.tsx updated successfully");
            } else {
    ...
    const handleDelete = async () => {
        try {
            const response = await deleteData("user/delete")
            ...
            navigate("/register");
            alert("Profile.tsx deleted successfully");
