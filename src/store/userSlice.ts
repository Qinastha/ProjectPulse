...
import {IProfile, UserPosition, UserRole} from "../core";
...
export const user = createSlice({
    ...
    reducers: (create: ReducerCreators<IUser>) => ({
        ...
        setProfileNull: create.reducer((state) => {
...
export const {getUser, getProfile, getUserInitial, getAvatar} =
    user.selectors;

export const {updateProfile, setUserInitial, setProfileNull} = user.actions;
